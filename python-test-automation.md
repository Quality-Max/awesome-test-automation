...
* [supply-chain-scanner](https://github.com/Quality-Max/supply-chain-scanner) - Open-source supply chain security scanner for Python dependencies. Catches .pth file injection, typosquatting, encoded payloads, obfuscation patterns, and compromised packages. 17 pytest tests, zero external dependencies, runs in 2 seconds. Apache 2.0.
