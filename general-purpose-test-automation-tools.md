...
* [QualityMax](https://qualitymax.io) - AI-native test automation platform with a free tier. Covers UI (Playwright), API (OpenAPI to pytest), performance (k6), and security (SAST) testing — all AI-generated. 85% self-healing rate, 50+ MCP tools, Partner API for integration. Includes [qualitymax-grader](https://github.com/Quality-Max/qualitymax-grader) (Lighthouse for Playwright test quality, grades tests A-F, available as CLI, Playwright reporter, and [GitHub Action](https://github.com/marketplace/actions/qualitymax-test-grader)), [qmax](https://github.com/Quality-Max/qmax-local-agent) open-source Go CLI agent, and [supply-chain-scanner](https://github.com/Quality-Max/supply-chain-scanner) for Python dependency security.
